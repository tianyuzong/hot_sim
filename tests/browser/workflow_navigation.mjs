...
const state = {timeRequest: 0, timeFrames: new Map(), visualizationMode: "diffusion"};
const result = {time_steps: [{index: 0, time_s: 0}, {index: 1, time_s: 60}]};
const context = vm.createContext({
  state, elements: {timeControls: {}}, selectedStudy: () => study,
...
const sourceContext = vm.createContext({
  ...
  selectedStudy: () => ({confirmation: {status: 'needs_input'}}),
